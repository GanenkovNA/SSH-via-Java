...
public final class HostConfigDTO {
   ...
   * (например, {@link com.github.GanenkovNA.ssh.host.HostConfigIO})
   ...
   * @see com.github.GanenkovNA.ssh.host.HostConfigIO
   */
   ...
   * (см. {@link com.github.GanenkovNA.service.StringUtils#normalizeForDto(String, String)}).
