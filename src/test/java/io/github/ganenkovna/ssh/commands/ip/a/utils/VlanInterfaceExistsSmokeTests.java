...
import static io.github.ganenkovna.ssh.commands.ip.a.utils.IpATestSupport.vlanInterfaceExists;
...
/**
 * Smoke-тесты для {@link IpATestSupport#vlanInterfaceExists(com.jcraft.jsch.Session, String, int)}.
 *
 ...
 *
 * @see IpATestSupport#vlanInterfaceExists(com.jcraft.jsch.Session, String, int)
